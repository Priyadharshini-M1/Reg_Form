...
function update() {
    ...
    // Create an object to represent the employee details
    var employeeDetails = {
        name: n.value,
        email: e.value,
        dob: d.value,
    ...
    // Append details to the webpage
    detailscontainer.innerHTML = ''; // Clear previous details
    detailscontainer.append(detailsEntered);

    // Send details to the server for database storage
...
// Function to send employee details to the server
